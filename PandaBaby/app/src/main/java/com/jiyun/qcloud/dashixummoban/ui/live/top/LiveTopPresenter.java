...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaTopIMPl;
...
public class LiveTopPresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveTopPresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaTopIMPl();
    }
