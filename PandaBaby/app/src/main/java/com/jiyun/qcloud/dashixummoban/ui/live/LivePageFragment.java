...
import com.jiyun.qcloud.dashixummoban.ui.live.live.LiveContract;
...
public class LivePageFragment extends BaseFragment implements LiveContract.View {
    ...
    protected void initView(View view) {
        ...
        live_viewpagerAdapter = new Live_Adapter(App.mBaseActivity.getSupportFragmentManager(), fragments, titles);
