...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaNewsIMPl;
...
public class LiveNewsPresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveNewsPresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaNewsIMPl();
    }
