package com.jiyun.qcloud.dashixummoban.ui.live.thing;
...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaThingIMPl;
...
public class LiveThingPresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveThingPresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaThingIMPl();
    }
