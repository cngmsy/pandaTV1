package com.jiyun.qcloud.dashixummoban.ui.live.file;
...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaFileIMPl;
...
public class LiveFilePresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveFilePresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaFileIMPl();
    }
