...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaRollIMPl;
...
public class LiveRollPresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveRollPresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaRollIMPl();
    }
