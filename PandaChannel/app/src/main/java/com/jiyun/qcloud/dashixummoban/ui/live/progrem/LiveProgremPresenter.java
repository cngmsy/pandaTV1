package com.jiyun.qcloud.dashixummoban.ui.live.progrem;
...
import com.jiyun.qcloud.dashixummoban.modle.liveModel.PandaProgremIMPl;
...
public class LiveProgremPresenter implements LiveWonderfulContract.Presenter{
     ...
     */
    public LiveProgremPresenter(LiveWonderfulContract.View liveWondView) {
        this.liveWondView = liveWondView;
        liveWondView.setPresenter(this);
        this.liveWondModel = new PandaProgremIMPl();
    }
